...
const PhotoUploadSection = ({
  ...
  // Note: PhotoUpload component needs to be imported from the original location
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="relative group">
        ...
        <div className="relative bg-white/80 dark:bg-gray-800/80 backdrop-blur-lg rounded-xl shadow-lg p-4 border border-white/20 dark:border-gray-700/50">
            ...
            <div className="bg-gray-100 dark:bg-gray-700 rounded-lg p-3 mb-4">
              ...
              <div className="w-full bg-gray-200 dark:bg-gray-600 rounded-full h-2 mt-2">
                <div
                  ...
                  style={{ width: `${(currentPhotoCount / maxPhotos) * 100}%` }}
                ></div>
              </div>
            </div>
