...
const UpgradePlanModal = ({
  ...
  const handleUpgrade = (targetPlan) => {
    ...
    smoothNavigate(`/pricing?from=events-limit-modal&plan=${targetPlan}`, {
      delay: 150,
      showLoader: true,
      replace: false,
    });
  ...
  const renderPremiumPlan = () => (
    <div className="border border-blue-200 dark:border-blue-800 rounded-xl p-3 sm:p-4 hover:border-blue-300 dark:hover:border-blue-700 transition-all duration-300 hover:shadow-lg animate-slide-up">
      ...
      {/* Features */}
      {renderFeatureList(premiumFeatures)}
          ...
          <div className="flex-1 overflow-y-auto scrollbar-thin scrollbar-thumb-gray-300 dark:scrollbar-thumb-gray-600 scrollbar-track-transparent">
            <div className="p-4 sm:p-6 space-y-4 sm:space-y-6">
              ...
              <div className="space-y-4">
                ...
                {/* Premium Plan - Only show if user is on Free plan */}
                {isFreePlan && renderPremiumPlan()}
