// components/EventActions/BulkEventActions.jsx
import React from 'react';
import { TrashIcon, ArchiveBoxIcon } from '@heroicons/react/24/outline';

const BulkEventActions = ({ selectedevents, onAction }) => {
  return (
    <div className="bg-blue-50/80 border border-blue-200 rounded-xl p-4">
      <div className="flex items-center justify-between">
        ...
        <div className="flex gap-2">
          <button
            onClick={() => onAction('archive', selectedevents)}
          ...
          <button
            onClick={() => onAction('delete', selectedevents)}
