...
const AllPhotosModal = ({
  ...
  return (
    <>
      ...
      >
        <div
          className="bg-white/95 dark:bg-gray-800/95 backdrop-blur-lg rounded-3xl shadow-2xl max-w-7xl max-h-[90vh] overflow-hidden w-full border border-white/20 dark:border-gray-700/50 flex flex-col event-modal-enter cursor-default modal-content-standard"
