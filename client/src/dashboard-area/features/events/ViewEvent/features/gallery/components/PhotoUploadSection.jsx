...
const PhotoUploadSection = ({
  ...
  return (
    ...
    >
      <div
        className="relative w-full max-w-2xl bg-white/90 dark:bg-gray-800/90 backdrop-blur-lg rounded-2xl shadow-2xl border border-white/20 dark:border-gray-700/50 overflow-hidden event-modal-enter cursor-default modal-content-standard"
      ...
      >
        ...
        <div className="p-6 space-y-4">
                            ...
                            <div className="bg-gray-50 dark:bg-gray-700/50 rounded-lg p-4 space-y-3">
                              ...
                              <div className="grid grid-cols-1 gap-2 max-h-32 overflow-y-auto">
                                {selectedFiles.map((fileData) => (
                                  <div
                                    key={fileData.id}
                                    className="flex items-center gap-3 bg-white dark:bg-gray-800 rounded-lg p-2"
                                  >
          ...
          {/* Upgrade Suggestions */}
          {(limitStatus === "full" || isApproachingPhotoLimit) &&
