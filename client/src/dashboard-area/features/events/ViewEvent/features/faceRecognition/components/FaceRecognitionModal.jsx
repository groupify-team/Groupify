...
const FaceRecognitionModal = ({
  ...
  return (
    <div className="modal-backdrop-standard event-modal-backdrop-enter">
      <div className="bg-white dark:bg-gray-800 rounded-2xl max-w-md w-full shadow-2xl border border-gray-200 dark:border-gray-700 event-modal-enter cursor-default modal-content-standard">
        {/* Header */}
