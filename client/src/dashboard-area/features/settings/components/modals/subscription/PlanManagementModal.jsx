                    ...
                    {subscription?.billing === "monthly" && (
                      <div className="bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-800 rounded-lg p-4">
                        <p className="text-sm text-green-800 dark:text-green-200">
                          <strong>💡 Save Money:</strong> Switch to yearly
                          billing and save{" "}
                          <strong>
                            $
                            {(
                ...
                <div className="space-y-4">
                  ...
                  <div className="bg-yellow-50 dark:bg-yellow-900/20 border border-yellow-200 dark:border-yellow-800 rounded-lg p-4">
                    <p className="text-sm text-yellow-800 dark:text-yellow-200">
                      <strong>⚠️ Important:</strong> Downgrading may result in
                      loss of access to premium features and data limits. Your
                ...
                <div className="bg-white/60 dark:bg-gray-800/60 backdrop-blur-sm rounded-xl border border-white/20 dark:border-gray-700/50 p-6">
                  ...
                  {subscription?.cancelAtPeriodEnd ? (
                    <div className="space-y-4">
                      ...
                      <button
                        onClick={() =>
                          setShowConfirmation({ type: "reactivate" })
                        }
                    ...
                    <div className="space-y-4">
                      <p className="text-sm text-gray-600 dark:text-gray-400">
                        Cancel your subscription and revert to the free plan.
                        You'll keep access to all premium features until the end
                      ...
                      <div className="bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800 rounded-lg p-4">
                        ...
                        <ul className="mt-2 text-xs text-red-700 dark:text-red-300 space-y-1">
                          ...
                          <li>
                            • Your storage will be limited to the free plan
                            limits
                          </li>
                          <li>
                            • Advanced AI features will no longer be available
                          </li>
                          <li>
                            • You can reactivate anytime before the cancellation
                            date
                          </li>
                        </ul>
                      </div>
