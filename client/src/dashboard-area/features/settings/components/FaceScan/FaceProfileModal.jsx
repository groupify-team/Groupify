...
const FaceProfileModal = ({ isOpen, onClose, onProfileCreated }) => {
  ...
  // Camera cleanup state
  const [currentStream, setCurrentStream] = useState(null);
  const smartFaceScanRef = useRef(null);
  ...
  // If user selected guided method, show SmartFaceScan component with proper cleanup handlers
