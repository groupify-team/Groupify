...
export const saveFaceProfileToStorage = async (userId, profileData) => {
  try {
    ...
    console.log('✅ Face profile metadata saved to Firestore');
  } catch (error) {
...
export const deleteFaceProfileFromStorage = async (userId) => {
  try {
    ...
    console.log('✅ Face profile metadata deleted from Firestore');
  } catch (error) {
...
export const updateFaceProfileInStorage = async (userId, updates) => {
  try {
    ...
    console.log('✅ Face profile metadata updated in Firestore');
  } catch (error) {
