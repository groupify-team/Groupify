// Enhanced Button Component with Smooth Transitions
import React from "react";
import { TRANSITIONS } from "@/shared/constants/transitions";
...
const Button = ({
  ...
  const baseClasses = `
    ...
    transition-all duration-200 ease-smooth transform-gpu
...
// Card component with hover transitions
export const Card = ({
  children,
  className = "",
  hoverable = true,
...
// Input component with focus transitions
