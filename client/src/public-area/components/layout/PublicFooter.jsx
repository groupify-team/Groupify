...
const PublicFooter = ({
  ...
  customText = null,
  className = "",
  handleSmoothNavigation, // Accept the navigation function as a prop
}) => {
  ...
  const handleLinkClick = (e, to) => {
    ...
    if (handleSmoothNavigation) {
      handleSmoothNavigation(to);
    } else {
      // Fallback to direct navigation if no smooth navigation provided
