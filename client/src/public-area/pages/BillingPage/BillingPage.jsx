...
const BillingPage = () => {
  ...
  const needsToCancelFirst = hasExistingPlan && userCurrentPlan.plan !== selectedPlan;
...
const ConflictMessages = ({ hasConflict, needsToCancelFirst, currentPlan, userCurrentPlan }) => {
  if (hasConflict) {
    return (
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-sm text-orange-700 dark:text-orange-300">
              Please cancel your current {userCurrentPlan.plan} plan before purchasing another one. You can do this from your dashboard settings.
            </p>
          </div>
        </div>
      </div>
...
const OrderSummary = ({ currentPlan, billingCycle, currentPrice, isYearly }) => (
