...
const HelpCenter = () => {
  ...
  const getArticleContent = (category, article) => {
    const articles = {
      ...
      "AI Face Recognition": {
        ...
        "Training the AI with your photos":
          "Help our AI recognize you better:\n\n**Profile Creation Options:**\n- **Smart Face Scan**: Guided camera capture for optimal results (recommended)\n- **Photo Upload**: Use 2-5 existing high-quality photos\n\n**Best Practices:**\n1. **Upload diverse photos** - Include photos from different angles and lighting\n2. **Use high-quality images** - Clear, well-lit photos work best\n3. **Follow the guidance** - Our Smart Face Scan provides real-time quality feedback\n4. **Minimum 2 photos** - At least 2 photos required, up to 5 recommended\n\n**Quality Requirements:**\n- Face clearly visible and well-lit\n- No sunglasses, masks, or heavy shadows\n- At least 300x300 pixels resolution\n\nThe AI learns from your feedback to provide better results over time.",
        "Improving recognition accuracy":
      ...
      "Privacy & Security": {
        ...
        "Search visibility settings":
          "Control who can find you:\n\n**Search Visibility Options:**\n- **Public** - Anyone can find you in search\n- **Friends Only** - Only existing friends can find you\n- **Private** - You won't appear in search results\n\n**How It Works:**\n- Controls appearance in friend search\n- Affects trip invitation discovery\n- Respects your privacy preferences\n\n**Friend Requests:**\n- Send requests to people you want to connect with\n- Accept or decline incoming requests\n- Manage pending requests\n\n**Privacy by Design:**\n- Your setting is respected across the platform\n- No third-party access to your search data\n- You can change this setting anytime",
        "Data export and deletion":
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer:
        "Free accounts get 2GB of storage with 5 trips and 30 photos per trip. Premium accounts get 50GB of storage with 50 trips and 200 photos per trip. Pro accounts get 500GB of storage with unlimited trips and photos per trip.",
    },
    {
    ...
    },
    {
      ...
      answer:
        "Open your trip, click the 'Share' button, and enter your friends' email addresses. They'll receive an invitation to view and contribute to your trip. You can set permissions for each person (view-only or full access). Member limits depend on your plan.",
    },
    {
      question: "Can I export my photos and data?",
      answer:
        "Yes! You can download individual photos, entire trips, or export all your data at any time. Go to Settings > Account > Export Data to download your photos in their original quality plus all your trip and account data.",
    },
    {
      question: "How do I create a face recognition profile?",
      answer:
        "Go to Settings > Face Profile and choose either Smart Face Scan (guided camera capture) or upload 2-5 existing high-quality photos. The Smart Face Scan provides the best results with real-time quality feedback.",
    },
    {
      question: "Can I delete photos from shared trips?",
      answer:
        "Trip owners and users with full access can delete photos. If you only have view access, you can't delete photos, but you can hide them from your personal view. All deletions are permanent and cannot be undone.",
    },
  ];
    ...
    >
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="mb-16">
          ...
          <div className="max-w-4xl mx-auto">
            {filteredFaqs.map((faq, index) => (
              <div key={index} className="bg-white dark:bg-gray-800 rounded-lg mb-4 shadow-sm border border-gray-200 dark:border-gray-700">
                <button
                  onClick={() => toggleFaq(index)}
                  className="w-full text-left p-4 sm:p-6 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-opacity-50 rounded-lg"
                >
