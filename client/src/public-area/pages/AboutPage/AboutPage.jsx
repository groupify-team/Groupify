  ...
  return (
    ...
    >
      <PageTransition variant="fadeIn" trigger={isLoaded}>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-12 md:gap-16 items-center">
                <div className="text-center lg:text-left">
                  ...
                  <p className="text-base sm:text-lg text-gray-600 dark:text-gray-300 mb-4 sm:mb-6 leading-relaxed">
                    ...
                    organizing and sharing memories should be as joyful as
                    creating them.
                  </p>
                  <p className="text-base sm:text-lg text-gray-600 dark:text-gray-300 mb-6 sm:mb-8 leading-relaxed">
                    That's why we built Groupify – to use the latest AI
                    technology to automatically organize your photos and make
                    sharing moments with friends and family effortless and
                    magical.
                  </p>
        ...
        {/* Founders Section */}
        <SectionTransition variant="slideInFromLeft" delay={0.3}>
        ...
        {/* Values Section */}
        <SectionTransition variant="slideInFromRight" delay={0.4}>
        ...
        {/* Timeline Section */}
        <SectionTransition variant="slideInFromBottom" delay={0.5}>
          <div className="py-12 sm:py-16 md:py-20">
          ...
          <div className="py-12 sm:py-16 md:py-20 bg-gradient-to-r from-indigo-600 to-purple-600">
            <div className="max-w-4xl mx-auto text-center px-4 sm:px-6 lg:px-8">
              ...
              <p className="text-base sm:text-lg md:text-xl text-indigo-100 mb-6 sm:mb-8 leading-relaxed max-w-2xl mx-auto">
                Ready to organize your memories and share them with the people
