        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          <div className="flex justify-between items-center">
            <div>
              ...
              <p className="text-indigo-200 mt-1">{trip.location || 'No location specified'}</p>
              <div className="flex mt-2 text-sm">
                <span className="mr-4">
                  <span className="font-medium">{trip.startDate || 'No start date'}</span>
                  {trip.startDate && trip.endDate && ' - '}
                  {trip.endDate && <span className="font-medium">{trip.endDate}</span>}
                </span>
          ...
          <div>
            <div className="bg-white rounded-lg shadow p-6">
              ...
              <form onSubmit={handleInvite}>
                ...
                <div className="mb-4">
                  <label className="block text-sm font-medium text-gray-700 mb-2" htmlFor="inviteEmail">
                    Email Address
                  </label>
                  <input
                    id="inviteEmail"
