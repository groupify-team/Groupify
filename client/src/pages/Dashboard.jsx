...
const Dashboard = () => {
  ...
  useEffect(() => {
    ...
    if (currentUser?.uid) fetchUserProfile();
  }, [currentUser]);
      ...
      <main className="max-w-7xl mx-auto py-6 sm:px-6 lg:px-8">
          ...
          <div className="bg-white p-4 rounded shadow mb-6">
            ...
            <ul className="space-y-2">
              {pendingInvites.map((invite) => (
                ...
                >
                  <span>
                    {invite.inviterName} invited you to join trip{" "}
        ...
        <div className="px-4 sm:px-0 mb-8">
          ...
          <button
            ...
            className="bg-indigo-600 hover:bg-indigo-700 text-white px-4 py-2 rounded-md text-sm font-medium ml-2"
          >
            Edit Details
          </button>
