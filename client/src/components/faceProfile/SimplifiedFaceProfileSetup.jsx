...
const SimplifiedFaceProfileSetup = ({ isOpen, onClose, onProfileCreated }) => {
  ...
  const handleCreateProfile = async () => {
    ...
    try {
      ...
      const uploadedImages = await uploadProfilePhotos(
        selectedImages,
        currentUser.uid
      );
      ...
      console.log('💾 Saving face profile metadata...');
      try {
        await saveFaceProfile(currentUser.uid, faceProfile, uploadedImages);
      } catch (storageError) {
        console.warn('Failed to save profile metadata:', storageError);
      ...
      if (error.message.includes('No faces detected')) {
        ...
        userMessage = 'Network issue detected. Please try refreshing the page and trying again.';
      }
        ...
        <div className="flex justify-between items-center p-6 border-b border-gray-200">
          <div>
            ...
            <p className="text-sm text-gray-600 mt-1">
              Add 2-5 clear photos of your face for automatic photo recognition in trips
            </p>
          </div>
          <button
            onClick={onClose}
...
export default SimplifiedFaceProfileSetup;