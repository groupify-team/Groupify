...
const TripDetailView = ({ tripId: propTripId }) => {
      ...
      <div className="flex items-center justify-center min-h-[60vh]">
        <div className="text-center">
          <div className="relative">
            ...
            <div className="absolute inset-0 w-16 h-16 border-4 border-transparent border-t-purple-500 rounded-full animate-pulse mx-auto"></div>
          </div>
          <p className="text-lg text-gray-700 font-medium">Loading trip details...</p>
          <p className="text-indigo-600 mt-2">Getting everything ready</p>
        </div>
      </div>
    );
  }
  ...
  if (error) {
    return (
      <div className="flex items-center justify-center min-h-[60vh]">
        <div className="text-center max-w-md mx-auto p-8 bg-red-50 rounded-2xl border border-red-200">
    ...
    <div className="space-y-6 p-4 sm:p-6 max-w-7xl mx-auto">
      ...
      <div className="grid grid-cols-1 xl:grid-cols-4 gap-6">
        ...
        <div className="xl:col-span-3 space-y-6">
                ...
                <div className="flex flex-wrap gap-3">
                  {isAdmin && (
                    <button
                      ...
                      className="px-4 py-2 bg-gradient-to-r from-blue-500 to-blue-600 text-white rounded-lg font-medium transition-all duration-300 transform hover:scale-105 shadow-md text-sm"
                    >
                      Edit Trip
                    </button>
                  )}
                  <button
                    ...
                    className="px-4 py-2 bg-gradient-to-r from-indigo-500 to-purple-500 text-white rounded-lg font-medium transition-all duration-300 transform hover:scale-105 shadow-md text-sm flex items-center gap-2"
                  >
          ...
          {showUploadForm && (
            <div className="group relative">
              <div className="absolute -inset-1 bg-gradient-to-r from-green-500 to-blue-500 rounded-2xl blur opacity-20 group-hover:opacity-30 transition duration-300"></div>
              <div className="relative bg-white rounded-xl shadow-lg p-6 border border-gray-100">
                <h2 className="text-xl font-bold text-gray-800 mb-4 flex items-center gap-3">
                  <div className="w-7 h-7 bg-gradient-to-r from-green-500 to-blue-500 rounded-lg flex items-center justify-center">
            ...
            <div className="relative bg-white rounded-xl shadow-lg p-6 border border-gray-100">
              <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-6">
                ...
                <button
                  ...
                  className="px-4 py-2 bg-gradient-to-r from-purple-500 to-pink-500 text-white rounded-lg font-medium transition-all duration-300 transform hover:scale-105 shadow-md text-sm flex items-center gap-2"
                >
                ...
                <div className="flex overflow-x-auto space-x-4 pb-4 scrollbar-hide">
                  {photos.slice(0, 6).map((photo, index) => (
                    <div
                      ...
                      className="flex-shrink-0 w-40 sm:w-48 cursor-pointer group relative"
                      onClick={() => setSelectedPhoto(photo)}
                    >
                      <div className="relative overflow-hidden rounded-xl shadow-md transform group-hover:scale-105 transition-all duration-300">
                        <img
                  ...
                  {photos.length > 6 && (
                    <div 
                      className="flex-shrink-0 w-40 sm:w-48 h-28 sm:h-32 bg-gradient-to-br from-purple-50 to-indigo-50 rounded-xl border-2 border-dashed border-purple-300 flex items-center justify-center cursor-pointer hover:from-purple-100 hover:to-indigo-100 transition-all duration-300"
                      onClick={() => setShowAllPhotosModal(true)}
                    >
                      <div className="text-center">
                        <div className="w-8 h-8 bg-purple-500 rounded-full flex items-center justify-center mx-auto mb-2">
                          <span className="text-white font-bold text-sm">+{photos.length - 6}</span>
                        </div>
                        <p className="text-purple-700 font-medium text-xs">View all</p>
                      </div>
                    </div>
                  )}
                </div>
          ...
          {/* Face Recognition Section - Enhanced and Responsive */}
          <div className="group relative">
            ...
            <div className="relative bg-white rounded-xl shadow-lg p-6 border border-gray-100">
              <div className="flex flex-col lg:flex-row justify-between items-start gap-4 mb-6">
                <div>
                  ...
                  <p className="text-gray-600 text-sm">AI-powered face recognition to find photos containing you</p>
                </div>
                  ...
                  <div className="flex flex-col sm:flex-row items-start sm:items-center gap-3">
                    ...
                    <div className="flex flex-wrap items-center gap-2">
                      {isLoadingProfile ? (
                        ...
                        <div className="flex items-center gap-2 bg-green-100 px-3 py-1 rounded-full text-xs">
                          <div className="w-2 h-2 bg-green-500 rounded-full animate-pulse"></div>
                          <span className="text-green-700 font-medium">Profile Ready</span>
                        </div>
                      ) : (
                        <div className="flex items-center gap-2 bg-orange-100 px-3 py-1 rounded-full text-xs">
                          <div className="w-2 h-2 bg-orange-500 rounded-full"></div>
                          <span className="text-orange-700 font-medium">No Profile</span>
                        </div>
                      )}

                      {hasCachedResults() && (
                        <div className="flex items-center gap-2 bg-blue-100 px-3 py-1 rounded-full text-xs">
                          <ClockIcon className="w-3 h-3 text-blue-600" />
                          <span className="text-blue-700 font-medium">Previous scan</span>
                        </div>
                      )}
                    </div>
                    ...
                    <div className="flex flex-wrap gap-2">
                      {hasCachedResults() && !filterActive && (
                        <button
                          ...
                          className="px-3 py-2 bg-blue-100 hover:bg-blue-200 text-blue-700 rounded-lg font-medium transition-all duration-300 text-xs flex items-center gap-1 disabled:opacity-50 disabled:cursor-not-allowed"
                        >
              ...
              {isProcessingFaces ? (
                <div className="space-y-4">
                  ...
                  <div className="space-y-3">
                    <div className="flex justify-between items-center">
                      <span className="font-semibold text-gray-700">Processing Photos</span>
                      <span className="text-xl font-bold text-blue-600">{getProgressPercentage()}%</span>
                    </div>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                    ...
                    {faceRecognitionProgress.matches?.length > 0 && (
                      <div className="bg-green-50 border border-green-200 rounded-xl p-4">
                        ...
                        <p className="text-green-600 text-xs">Found so far...</p>
                      </div>
                    )}
                  </div>
                  ...
                  <button
                    ...
                    className="w-full bg-gradient-to-r from-red-500 to-red-600 hover:from-red-600 hover:to-red-700 text-white font-semibold py-3 px-4 rounded-xl transition-all duration-300 flex items-center justify-center gap-2"
                  >
                ...
                <div className="text-center py-12">
                  ...
                  <p className="text-gray-500 text-sm">No photos containing you were found using your face profile.</p>
                </div>
              ) : filterActive ? (
                <div className="space-y-4">
                    ...
                    <div className="bg-blue-50 border border-blue-200 rounded-xl p-4">
                      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3">
                        <div className="flex items-center gap-3">
                          ...
                          <div>
                            <p className="font-semibold text-blue-800 text-sm">Showing previous results</p>
                            <p className="text-blue-600 text-xs">
                              Scanned on {new Date(lastScanTimestamp).toLocaleDateString()}
                            </p>
                          </div>
                        </div>
                        <button
                ...
                <div className="text-center py-12">
                  ...
                  {!hasProfile && (
                    <button
                      onClick={() => navigate("/dashboard")}
                      className="bg-gradient-to-r from-blue-500 to-cyan-500 hover:from-blue-600 hover:to-cyan-600 text-white px-6 py-3 rounded-xl font-medium transition-all duration-300 transform hover:scale-105 shadow-lg"
                    >
                      Setup Face Profile
                    </button>
                  )}
        ...
        {/* Sidebar - Takes 1 column on xl screens, full width on smaller screens */}
                ...
                <div className="space-y-3">
                  {[...tripMembers]
                    ...
                    .map((member) => (
                      <div
                        key={member.uid}
                        className="group flex items-center justify-between p-3 rounded-lg bg-gray-50 hover:bg-gray-100 transition-all duration-300 cursor-pointer"
                        onClick={async () => {
                      ...
                      >
                        ...
                        <div className="flex-shrink-0">
                          {member.uid === trip.createdBy ? (
                            ...
                            <span className="bg-gradient-to-r from-blue-500 to-cyan-500 text-white text-xs font-semibold px-2 py-1 rounded-full">
                              Admin
                            </span>
                          ) : (
      ...
      {/* Modals remain the same but with responsive improvements */}
      {selectedUser && (
        <UserProfileModal
          user={selectedUser}
      ...
      {selectedPhoto && (
        ...
        >
          <div className="relative max-w-5xl max-h-[90vh] rounded-2xl overflow-hidden shadow-2xl">
            <img
      ...
      {showAllPhotosModal && (
        ...
        >
          <div
            className="bg-white rounded-2xl shadow-2xl max-w-6xl max-h-[85vh] overflow-hidden w-full"
                ...
                <div className="flex flex-wrap items-center gap-2">
                  {selectMode && selectedPhotos.length > 0 && (
                    <button
                      ...
                      className="px-4 py-2 bg-gradient-to-r from-red-500 to-red-600 text-white rounded-lg font-medium transition-all duration-300 text-sm flex items-center gap-2"
                    >
                  ...
                  <button
                    onClick={() => setShowAllPhotosModal(false)}
                    className="px-4 py-2 bg-gradient-to-r from-gray-500 to-gray-600 text-white rounded-lg font-medium transition-all duration-300 text-sm"
                  >
                    Close
                  </button>
                </div>
                ...
                <div className="grid grid-cols-3 sm:grid-cols-4 md:grid-cols-5 lg:grid-cols-6 gap-3">
                  {photos.map((photo) => {
                    ...
                    return (
                      <div
                        key={`modal-${photo.id}`}
                        className={`relative cursor-pointer rounded-xl overflow-hidden shadow-md transform transition-all duration-300 hover:scale-105 ${
                      ...
                      >
                        ...
                        />
                        {selectMode && (
                          <div className="absolute top-2 right-2 w-5 h-5 border-2 border-white rounded-full bg-white flex items-center justify-center shadow-lg">
                            {isSelected && (
      ...
      {/* Toast Notifications */}
      {showSuccess && (
        <div className="fixed top-8 right-8 bg-gradient-to-r from-green-500 to-emerald-500 text-white px-6 py-4 rounded-xl shadow-2xl z-50 transform animate-bounce">
          <div className="flex items-center gap-3">
      ...
      {cancelSuccess && (
        <div className="fixed top-8 right-8 bg-gradient-to-r from-red-500 to-red-600 text-white px-6 py-4 rounded-xl shadow-2xl z-50 transform animate-bounce">
          <div className="flex items-center gap-3">
            <XMarkIcon className="w-5 h-5" />
            {cancelSuccess}
          </div>
